...
val foodDatabase = linkedMapOf(
    ...
    // 아래 30종은 음식 인식 모델(yolov8n_food)의 클래스와 1:1 대응한다. 1인분 기준 근사값이며
    // 식약처 영양 DB 연동 전까지의 임시 수치다 — 사용자가 결과 화면에서 수량으로 조절한다.
    ...
    "닭갈비" to Nutrition(450, 25.0, 35.0, 22.0),
    "더덕구이" to Nutrition(130, 22.0, 3.0, 3.0),
    "떡갈비" to Nutrition(280, 15.0, 16.0, 17.0),
    "불고기" to Nutrition(300, 12.0, 25.0, 16.0),
