...
object CoachCues {
    ...
    private val entries: List<Entry> = listOf(
        ...
        // spec §62a 반복별 검사(RepFormSpecs) — 부위명·리포트 폴백 문장. 실제 관찰문은 검사가 방향별로 갖고 있다(RuleResult.measurement)
        e("발끝 방향", "발끝", "처음부터 발끝이 바깥으로 많이 벌어져 있어요. 발끝은 살짝만 바깥으로 두세요.", "발끝이 점점 바깥으로 벌어져요. 발끝을 살짝만 바깥으로 두세요."),
        e("발 간격", "발 너비", "처음부터 발 너비가 어깨 너비를 벗어나 있어요. 발을 어깨 너비로 두세요.", "발 너비가 점점 달라져요. 발을 어깨 너비로 두세요."),
        e("무릎 안쪽 모임", "무릎", "처음부터 바닥에서 무릎이 안쪽으로 모여요. 무릎을 발끝 방향으로 두세요.", "바닥에서 무릎이 점점 안쪽으로 모여요. 무릎을 발끝 방향으로 두세요."),
        e("무릎 과도 벌림", "무릎", "처음부터 바닥에서 무릎이 과하게 벌어져요. 무릎을 발끝 방향에 맞추세요.", "바닥에서 무릎이 점점 과하게 벌어져요. 무릎을 발끝 방향에 맞추세요."),
        e("상체 숙임", "상체", "처음부터 상체가 시작보다 많이 숙여져요. 가슴을 들고 몸통을 세우세요.", "상체가 점점 많이 숙여져요. 가슴을 들고 몸통을 세우세요."),
        e("엉덩이 먼저 상승", "엉덩이", "처음부터 올라올 때 엉덩이가 먼저 올라와요. 무릎과 엉덩이를 같이 펴세요.", "올라올 때 엉덩이가 점점 먼저 올라와요. 무릎과 엉덩이를 같이 펴세요."),
        e("좌우 무릎 비대칭", "좌우 균형", "처음부터 체중이 한쪽으로 쏠려 있어요. 양발에 체중을 고르게 두세요.", "체중이 점점 한쪽으로 쏠려요. 양발에 체중을 고르게 두세요."),
        e("몸통 좌우 기울기", "몸통", "처음부터 몸통이 옆으로 기울어 있어요. 양 어깨 높이를 맞추세요.", "몸통이 점점 옆으로 기울어요. 양 어깨 높이를 맞추세요."),
